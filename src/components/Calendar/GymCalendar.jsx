...
import NewGymEvent from './NewGymEvent'
...
export default function GymCalendar() {
  ...
  function handleDateSelect(selectInfo) {
    if (fullcalendar.current.getApi().view.type === "dayGridMonth") {
      navigate(`/gym_calendar/day/${selectInfo.startStr}`)
  ...
  return (
    <div className='calendar'>
      ...
      <Modal isOpen={newEventModalIsOpen}>
        ...
        <NewGymEvent temporalInfo={temporalInfo} addEvent={addEvent} setIsOpen={setNewEventModalIsOpen} isUserLoggedIn={isUserLoggedIn} />
      </Modal>
